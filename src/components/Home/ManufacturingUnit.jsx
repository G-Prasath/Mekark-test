...
const ManufacturingUnit = () => {
  return (
    <div className="lg:mt-[100px] my-10">
        ...
        <section className="col-span-12 px-5 grid gap-8 sm:grid-cols-2 lg:grid-cols-3 lg:gap-0 mx-auto md:px-0">
          {ManufacturingData.map((item, index) => (
            ...
            >
              ...
              <div className="bg-white lg:aspect-square flex text-center justify-center flex-col p-10 relative">
                <div
                ...
                <h3 className="uppercase text-xl font-bold" data-aos="zoom-in-right" data-aos-duration="2500">{item.title}</h3>

                <span className="w-10 h-0.5 bg-gray-400 block mx-auto mt-2 mb-5"></span>
                <p className="mb-5" data-aos="zoom-in-left" data-aos-duration="3000">{item.description}</p>
