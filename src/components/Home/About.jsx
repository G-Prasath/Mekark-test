...
const About = () => {
  ...
  return (
    <section className="area md:h-screen h-auto">
      ...
      <div className="content relative z-10 flex flex-col md:flex-row gap-6 items-center lg:py-10 pt-10 px-4 xl:px-20">
        ...
        <div className="md:w-3/6 w-full max-sm:order-1 about-card max-sm:p-4 max-sm:my-5 max-lg:p-4 max-md:my-2 rounded-lg">
          <h1 className="text-3xl font-bold text-gray-800 mt-10 md:mt-0 mb-4" data-aos="fade-left" data-aos-duration="1500">
            {expandedImg.alt}
          </h1>
