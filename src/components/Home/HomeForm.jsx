    ...
    <header className="bg-gray-100 lg:py-20 md:pb-14 max-sm:pb-12">
      <div className="xl:grid place-items-center place-content-center xl:grid-cols-2 xl:max-w-screen-xl mx-auto w-11/12 gap-14">
        ...
        <div className="max-w-xl mx-auto xl:max-w-2xl xl:-mt-8 ">
          <p className="text-2xl pt-10 xl:text-5xl font-semibold xl:leading-snug text-gray-900 2xl:text-3xl 2xl:leading-snug mb-10" data-aos="zoom-in-left" data-aos-duration="1500">
          ...
          >
            {({ touched, errors }) => (
              <Form className="space-y-6" data-aos="zoom-in-right" data-aos-duration="1900">
        ...
        {/* Right Section (Cards) */}
        <div className="w-full aspect-auto lg:flex hidden justify-center items-center" data-aos="zoom-in-up" data-aos-duration="1500">
          <img
