            ...
            {DesignServicesData.map((item, index) => (
              ...
              >
                <div
                  ...
                  href={item.link}
                >
                  <h3 className="absolute inset-x-0 lg:bottom-12 bottom-16 text-lg p-6 font-bold md:px-12 md:py-8 md:whitespace-nowrap mb-4 md:truncate md:opacity-0 group-hover/article:opacity-100 group-focus-within/article:opacity-100 md:translate-y-2 group-hover/article:translate-y-0 group-focus-within/article:translate-y-0 transition duration-200 ease-[cubic-bezier(.5,.85,.25,1.8)] group-hover/article:delay-300 group-focus-within/article:delay-300">
                    {item.title}
                  </h3>
                  <p className="absolute leading-6 inset-x-0 mb-4 bottom-0 text-lg max-sm:text-md p-6 md:px-12 md:py-8 md:whitespace-nowrap md:truncate md:opacity-0 group-hover/article:opacity-100 group-focus-within/article:opacity-100 md:translate-y-2 group-hover/article:translate-y-0 group-focus-within/article:translate-y-0 transition duration-200 ease-[cubic-bezier(.5,.85,.25,1.8)] group-hover/article:delay-300 group-focus-within/article:delay-300">
                    {item.quote}
                  </p>
                </div>
                <img
