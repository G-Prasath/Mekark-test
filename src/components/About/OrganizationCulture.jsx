      ...
      <section className="max-w-screen-xl mx-auto py-20 px-8 lg:px-10">
        ...
        <div className="flex flex-col gap-6 mt-16">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div
              className="w-full lg:w-9/12 bg-red-100 rounded-3xl flex flex-col justify-center p-8 lg:p-14"
          ...
          <div className="flex flex-col md:flex-row-reverse gap-6">
            ...
            <div
              className="w-full lg:w-9/12 bg-blue-100 rounded-3xl flex flex-col justify-center p-8 lg:p-14"
              data-aos="zoom-out-right"
              data-aos-duration="700"
            >
